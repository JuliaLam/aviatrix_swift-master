...
func refuel(myPlane : Aviatrix) {
    ...
    let fuelPrices = myPlane.data2.fuelPrices[myPlane.location]!
    print("Refueling...")
    print("⛽ Here in \(myPlane.location), jet fuel costs \(fuelPrices)")
    print("⛽ You refueled \(refuelData) gallons totaling \(fuelPrices*refuelData)")
}
...
var plane = Aviatrix(authorName: "Julia")
